...
def send_reservation_requested_email(unit_email: str | None, unit_name: str, terrain_name: str, start_time: str, end_time: str):
...
def send_reservation_approved_email(unit_email: str | None, unit_name: str, terrain_name: str, start_time: str, end_time: str):
...
def send_reservation_rejected_email(unit_email: str | None, unit_name: str, terrain_name: str, start_time: str, end_time: str):
